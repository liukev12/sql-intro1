...
select players.first_name, players.last_name from players inner join stats inner join teams on players.id = stats.id = teams.id where teams.name = "Chicago Cubs" and teams.year = 2020
